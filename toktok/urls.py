...
from main.views import home, change_password, solo_arrendadores, solo_arrendatarios,profile, edit_user
...
urlpatterns = [
    ...
    path('accounts/change-pass/', change_password, name="change_passwor"),
